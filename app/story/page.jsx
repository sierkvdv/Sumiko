  ...
  return (
    <main className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-12">
      ...
      <section className="mt-6 space-y-4 text-neutral-800">
        <p>It began in Tokyo, in a small underground club at dawn. The music was fading, the lights were low, and the city outside was just beginning to wake. That’s where Sumiko’s story took shape.</p>
        <p>Sumiko was born in Japan, to Chinese parents — two tea lineages carried quietly in one life. From China: the mountains, the harvests, the leaves themselves. From Japan: the stillness, the presence, the way tea is not performed but felt.</p>
        ...
        <p>Sumiko already shared her teas in Japan, slowly, one person at a time. The idea grew: share them here — in Europe — without losing that warmth. Not as a brand. Not as a trend. But as a way to make space for a slower, more human rhythm again.</p>
      </section>
